...
AHRS::AHRS(ImuDriverBase *imu_driver)
{
    ...
    kp_                        = 1.3f;
    ki_                        = 0.01f;
    gyro_y_conv_angle_         = IMU_GYRO_Y_CONVERT_ANGLE_DEFAULT;
    imu_static_gyro_threshold_ = 8;
}
...
void rotateVectorByQuaternion(const Quaternion &q, float &x, float &y, float &z)
{
    ...
    temp2.q0 = temp1.q0 * q_conjugate.q0 - temp1.q1 * q_conjugate.q1 - temp1.q2 * q_conjugate.q2 -
               temp1.q3 * q_conjugate.q3;
    temp2.q1 = temp1.q0 * q_conjugate.q1 + temp1.q1 * q_conjugate.q0 + temp1.q2 * q_conjugate.q3 -
               temp1.q3 * q_conjugate.q2;
    temp2.q2 = temp1.q0 * q_conjugate.q2 - temp1.q1 * q_conjugate.q3 + temp1.q2 * q_conjugate.q0 +
               temp1.q3 * q_conjugate.q1;
    temp2.q3 = temp1.q0 * q_conjugate.q3 + temp1.q1 * q_conjugate.q2 - temp1.q2 * q_conjugate.q1 +
               temp1.q3 * q_conjugate.q0;
...
{
    imu_driver_->Loop();
    imu_data_ = imu_driver_->GetImuData();
    ...
    gyro_conv_.Loop(
        ...
        imu_data_.gyro.gz,
        imu_data_.gyro.gx);
    imu_data_.gyro.gz = -imu_data_.gyro.gz;
}
